      ...
      options: {
        ...
        onClick(evt, elements) {
          ...
          chart.data.datasets.forEach((ds,i) => {
            ds.pointRadius = i===di ? 6 : 2;
            ds.backgroundColor = i===di ? ds.borderColor+'ee' : ds.borderColor+'22';
          });
      ...
      onClick(evt, elements) {
        if (!elements.length) {
          ...
          chart.data.datasets.forEach(ds => {
            ...
            ds.backgroundColor = ds.borderColor.replace(/..$/,'99');
        ...
        chart.data.datasets.forEach((ds, i) => {
          if (i === di) {
            ...
            ds.backgroundColor = ds.borderColor.replace(/..$/,'ee');
          } else {
            ds.pointRadius = ctype==='scatter' ? 2 : 1;
            ds.pointHoverRadius = 5;
            ds.backgroundColor = ds.borderColor.replace(/..$/,'22');
          }
        });
        const lbl = document.getElementById('site-label');
        lbl.textContent = '● ' + siteName;
